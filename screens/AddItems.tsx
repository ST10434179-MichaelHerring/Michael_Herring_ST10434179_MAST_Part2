...
const styles = StyleSheet.create({
  ...
  picker: {
    height: 50,
    width: '80%',  // Ensure it's in line with the input boxes
    backgroundColor: '#EDBEA4',  // You can add a background for consistency
    borderRadius: 25,
    marginBottom: 10,  // Ensure spacing below the picker
  },
  box: {
    width: '110%',
